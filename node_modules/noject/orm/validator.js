...
var __schemes = require('./schemes.js'),
    __check = require('../node_modules/validator').check;
...
module.exports = {
    ...
    validateProperty: function (modelType, propertyKey, propertyValue) {
        var scheme = __schemes[modelType][propertyKey],
            isValid = true;
            ...
            if (rule === 'minLength') {
                ...
                switch (ruleValue) {
                    ...
                    case 'slug':
                        ...
                        try {
                            __check(value).notEmpty().notContains(' ');
                        }
                        catch (e) {
                            isValid = false;
                            //console.log(e.name + ': ' + e.message);
