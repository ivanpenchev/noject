...
(function () {
    ...
    module.exports = Node = (function (_super) {
                        ...
                        __tryCatch(_, function __$Node_prototype_save__1() {
                            return (function __$Node_prototype_save__1(__then) {
                                ...
                                if (__this.exists) {
                                    ...
                                    /*    57 */
                                    return __this.db.getServices(__cb(_, __frame, 21, 21, function ___(__0, __2) {
                                        /*    57 */
                                        services = __2;
                                        /*    58 */
                    ...
                    (function ___(_) {
                        __tryCatch(_, function __$Node_prototype_delete__2() {
                            return (function __$Node_prototype_delete__2(__then) {
                                ...
                                if (force) {
                                    /*    89 */
                                    return __this.all(null, __cb(_, __frame, 10, 26, function ___(__0, __2) {
                                        /*    89 */
                                        relationships = __2;
                                        /*    98 */
                                        return (function __1(_) {
                                            ...
                                            for (_i = 0, _len = relationships.length; (_i < _len); _i++) {
                                                ...
                                                /*    95 */
                                                _results.push(relationship["delete"]());
                                            }
                                            ;
                                            /*    97 */
                                            return _(null, _results);
                                            /*    98 */
                                        })(__cb(_, __frame, 19, 27, function ___(__0, __3) {
                                                /*    90 */
                                                return flows.collect(__cb(_, __frame, 11, 10, __then, true), __3);
                                            }, true));
                                    }, true));
                                }
                                else {
        ...
        /*   106 */
        Node.prototype.index = function Node_prototype_index__3(index, key, value, _, uniqueness) {
            var uniqueness;
                                ...
                                return __this.db.getVersion(__cb(_, __frame, 7, 18, function ___(__0, __2) {
                                    ...
                                    return (function __$Node_prototype_index__3(__then) {
                                        ...
                                        if ((version <= 1.4)) {
                                            ...
                                            if (uniqueness) {
                                                urlToPost += '?uniqueness=create_or_fail';
                                            }
        ...
        /*   140 */
        Node.prototype.createRelationshipTo = function Node_prototype_createRelationshipTo__4(otherNode, type, data, _) {
            var __this = this;
            var __frame = {
        ...
        /*   144 */
        Node.prototype.createRelationshipFrom = function Node_prototype_createRelationshipFrom__5(otherNode, type, data, _) {
            var __this = this;
            var __frame = {
        ...
        /*   148 */
        Node.prototype._createRelationship = function Node_prototype__createRelationship__6(from, to, type, data, _) {
        ...
        /*   185 */
        Node.prototype._getRelationships = function Node_prototype__getRelationships__7(direction, type, _) {
                ...
                return (function ___(__then) {
                    (function ___(_) {
                        __tryCatch(_, function __$Node_prototype__getRelationships__7() {
                            ...
                            ;
                            /*   202 */
                            return __this._request.get(relationshipsURL, __cb(_, __frame, 17, 15, function ___(__0, __1) {
                                /*   202 */
                                resp = __1;
                                /*   203 */
        ...
        /*   221 */
        Node.prototype.getRelationships = function Node_prototype_getRelationships__8(type, _) {
            var __this = this;
            var __frame = {
        ...
        /*   225 */
        Node.prototype.outgoing = function Node_prototype_outgoing__9(type, _) {
            var __this = this;
            var __frame = {
        ...
        /*   229 */
        Node.prototype.incoming = function Node_prototype_incoming__10(type, _) {
            var __this = this;
            var __frame = {
        ...
        /*   233 */
        Node.prototype.all = function Node_prototype_all__11(type, _) {
            var __this = this;
            var __frame = {
        ...
        /*   275 */
        Node.prototype.path = function Node_prototype_path__13(to, type, direction, maxDepth, algorithm, _) {
