...
var __rt = require('streamline/lib/callbacks/runtime').runtime(__filename), __func = __rt.__func, __cb = __rt.__cb;
function DataBuffer(options) {
    ...
    this.read = function read__1(_, len) {
        ...
        var __frame = { name: "read__1", line: 17 };
        return __func(_, this, arguments, read__1, 0, __frame, function __$read__1() {
            if ((len < 0)) {
                len = Infinity;
            }
            ;
    ...
    this.readAll = function readAll__2(_) {
        var __this = this;
        var __frame = { name: "readAll__2", line: 39 };
        return __func(_, this, arguments, readAll__2, 0, __frame, function __$readAll__2() {
    ...
    this.write = function write__3(_, data, enc) {
        var __this = this;
        var __frame = { name: "write__3", line: 50 };
        return __func(_, this, arguments, write__3, 0, __frame, function __$write__3() {
            _chunks.push(data);
