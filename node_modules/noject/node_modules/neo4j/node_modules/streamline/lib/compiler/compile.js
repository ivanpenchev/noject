/*** Generated by streamline 0.4.11 (callbacks) - DO NOT EDIT ***/ "use strict";
...
function mtime(_, fname) {
    var __frame = { name: "mtime", line: 18 };
...
exports.compileFile = function exports_compileFile__1(_, js_, options) {
    ...
    var __frame = { name: "exports_compileFile__1", line: 74 };
    return __func(_, this, arguments, exports_compileFile__1, 0, __frame, function __$exports_compileFile__1() {
        ...
        return mtime(__cb(_, __frame, 7, 16, function ___(__0, __2) {
            mtimejs_ = __2;
            return mtime(__cb(_, __frame, 8, 15, function ___(__0, __3) {
                mtimejs = __3;
                transform = _getTransform(options);

                banner = _banner(transform.version);
                options.sourceName = js_;
                return fs.readFile(js_, "utf8", __cb(_, __frame, 13, 15, function ___(__0, __4) {
                    content = __4;
                    ...
                    return (function __$exports_compileFile__1(_) {
                        ...
                        ;
                        return fs.readFile(js, "utf8", __cb(_, __frame, 27, 30, _, true));
                    })(__cb(_, __frame, -73, 6, function ___(__0, __5) {
                            transformed = __5;
                            ...
                            return (function __$exports_compileFile__1(__then) {
                                if (((options.action === "compile") || !dontSave)) {
                                    return (function ___(__then) {
                                        (function ___(_) {
                                            __tryCatch(_, function __$exports_compileFile__1() {


                                                return fs.writeFile(js, transformed, "utf8", __cb(_, __frame, 38, 3, __then, true));
                                            });
...
exports.loadFile = function exports_loadFile__2(_, path, options) {
    ...
    var __frame = { name: "exports_loadFile__2", line: 130 };
    return __func(_, this, arguments, exports_loadFile__2, 0, __frame, function __$exports_loadFile__2() {
        ...
        return (function __$exports_loadFile__2(__then) {
            if (((ext !== ".js") && (ext !== "._js"))) {
                ...
                return _exists(__cb(_, __frame, 6, 6, function ___(__0, __3) {
                    return (function __$exports_loadFile__2(__then) {
                        if (__3) {
                            path = (path + (ext = "._js"));
                            __then();
                        } else {
                            return _exists(__cb(_, __frame, 7, 11, function ___(__0, __4) {
                                return (function __$exports_loadFile__2(__then) {
                                    if (__4) {
                                        path = (path + (ext = ".js"));
                                        __then();
            ...
            fiberjs = ((((dirname + "/") + jsbase) + "--fibers") + ext);
            return (function __$exports_loadFile__2(_) {
                var __1 = options.fibers;
                if (!__1) {
                    return _(null, __1);
                }
                ;
                return mtime(__cb(_, __frame, 19, 34, function ___(__0, __3) {
                    var __2 = (mtimejs = __3);
                    return _(null, __2);
                }, true), fiberjs);
            })(__cb(_, __frame, -129, 6, function ___(__0, __5) {
                    return (function __$exports_loadFile__2(__then) {
                        if (__5) {
                            js = fiberjs;
                            __then();
                            ...
                            return mtime(__cb(_, __frame, 22, 12, function ___(__0, __6) {
                                mtimejs = __6;
                                __then();
                            }, true), js);
                        }
                        ...
                        return mtime(__cb(_, __frame, 24, 12, function ___(__0, __7) {
                            mtimejs_ = __7;
                            options.lines = (options.lines || "preserve");
                            ...
                            return (function __$exports_loadFile__2(__then) {
                                if (mtimejs_) {
                                    options.sourceName = js_;
                                    return fs.readFile(js_, "utf8", __cb(_, __frame, 31, 16, function ___(__0, __8) {
                                        content = __8;
                                        shebangparse = parseShebang(content);
                                        shebang = shebangparse[0];
                                        le = shebangparse[2];
                                        ...
                                        return (function __$exports_loadFile__2(_) {
                                            ...
                                            ;
                                            return fs.readFile(js, "utf8", __cb(_, __frame, 38, 31, _, true));
                                        })(__cb(_, __frame, -129, 6, function ___(__0, __9) {
                                                transformed = __9;
                                                if ((((transformed && (mtimejs_ < mtimejs)) && (transformed.substring(0, banner.length) == banner)) && !options.force)) {
                                                    return _(null, transformed);
                                                }
                                                ...
                                                return (function __$exports_loadFile__2(__then) {
                                                    if (((options.action === "compile") || !dontSave)) {
                                                        return (function ___(__then) {
                                                            (function ___(_) {
                                                                __tryCatch(_, function __$exports_loadFile__2() {


                                                                    return fs.writeFile(js, transformed, "utf8", __cb(_, __frame, 49, 4, __then, true));
                                                                });
                                                            })(function ___(ex, __result) {
                                                                __tryCatch(_, function __$exports_loadFile__2() {
                                                                    if (ex) {
                                    ...
                                    return fs.readFile(js, "utf8", __cb(_, __frame, 55, 16, function ___(__0, __10) {
                                        content = __10;
                                        shebangparse = parseShebang(content);
                                        shebang = shebangparse[0];
                                        le = shebangparse[2];
                                        ...
                                        return (function __$exports_loadFile__2(__then) {
                                            ...
                                            if ((ext === "._js")) {
                                                return cachedTransform(__cb(_, __frame, 64, 10, _, true), content, path, transform, banner, options);
                                            } else {
                                                return (function __$exports_loadFile__2(__then) {
                                                    if (matches = streamlineRE.exec(content)) {
                                                        content = removeMarker(content, matches, options);
                                                        return cachedTransform(__cb(_, __frame, 67, 10, _, true), content, path, transform, banner, options);
                                                    } else {

                                                        return _(null, content);
                                                    }
                                                    ;
                                                })(__then);
                                            }
...
if (((process.env.HOME === undefined) && (process.env.HOMEDRIVE === undefined))) {
    throw new Error("HOME not found, unable to store Streamline callback cache")
}
;
...
function mkdirs(_, path) {
    var p, i, segs, seg;
    var __frame = { name: "mkdirs", line: 289 };
            ...
            var __loop = __cb(_, __frame, 0, 0, function __$mkdirs() {
                ...
                if (__3) {
                    ...
                    return (function __$mkdirs(_) {
                        ...
                        ;
                        return _exists(__cb(_, __frame, 7, 16, function ___(__0, __3) {
                            var __2 = !__3;
                            return _(null, __2);
                        }, true), p);
                    })(__cb(_, __frame, -288, 6, function ___(__0, __2) {
                            return (function __$mkdirs(__then) {
                                if (__2) {
                                    return (function ___(__then) {
                                        (function ___(_) {
                                            __tryCatch(_, function __$mkdirs() {

                                                return fs.mkdir(p, dirMode, __cb(_, __frame, 9, 4, __then, true));
                                            });
...
function cachedTransform(_, content, path, transform, banner, options) {
    ...
    var __frame = { name: "cachedTransform", line: 312 };
    return __func(_, this, arguments, cachedTransform, 0, __frame, function __$cachedTransform() {
        ...
        return mkdirs(__cb(_, __frame, 9, 1, function __$cachedTransform() {
            ...
            return mtime(__cb(_, __frame, 11, 5, function ___(__0, __2) {
                return mtime(__cb(_, __frame, 11, 19, function ___(__0, __3) {
                    var __1 = (__2 > __3);
                    return (function __$cachedTransform(__then) {
                        if (__1) {
                            return fs.readFile(f, "utf8", __cb(_, __frame, 12, 16, function ___(__0, __4) {
                                transformed = __4;
                        ...
                        if (options.verbose) {
                            console.log(("streamline: transforming: " + path));
                        }
                        ;
                        ...
                        return (function __$cachedTransform(__then) {
                            if ((path.indexOf("/tmp--") < 0)) {
                                return fs.writeFile(f, transformed, "utf8", __cb(_, __frame, 19, 33, __then, true));
                            } else {
                                __then();
                            }
                            ;
...
exports.compile = function exports_compile__3(_, paths, options) {
    var failed, transform, cwd;

    function _compile(_, path, options) {
        var stat, ext, jsPath, source, coffee, compiled, matches;
        var __frame = { name: "_compile", line: 392 };
        return __func(_, this, arguments, _compile, 0, __frame, function __$_compile() {
            return fs.stat(path, __cb(_, __frame, 1, 13, function ___(__0, __3) {
                stat = __3;
                return (function __$_compile(__then) {
                    if (stat.isDirectory()) {
                        return fs.readdir(path, __cb(_, __frame, 3, 3, function ___(__0, __4) {
                            return __4.forEach_(__cb(_, __frame, 3, 3, __then, true), function __1(_, f) {
                                var __frame = { name: "__1", line: 395 };
                                return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
                                    return _compile(__cb(_, __frame, 1, 4, _, true), ((path + "/") + f), options);
                                });
                            });
                        }, true));
                    } else {
                                            ...
                                            return exports.loadFile(__cb(_, __frame, 8, 4, function __$_compile() {
                                                ...
                                                return (function __$_compile(__then) {
                                                    if (((ext === "._js") || (ext === "._coffee"))) {
                                                        return exports.compileFile(__cb(_, __frame, 11, 5, __then, true), path, options);
                                                    } else {
                                                        return (function __$_compile(__then) {
                                                            if (((ext === ".coffee") && (path[((path.length - ext.length) - 1)] !== "_"))) {
                                                                jsPath = (path.substring(0, (path.length - ext.length)) + ".js");
                                                                return (function __$_compile(_) {
                                                                    var __2 = options.force;
                                                                    if (__2) {
                                                                        return _(null, __2);
                                                                    }
                                                                    ;
                                                                    return mtime(__cb(_, __frame, 14, 26, function ___(__0, __4) {
                                                                        return mtime(__cb(_, __frame, 14, 43, function ___(__0, __5) {
                                                                            var __3 = (__4 > __5);
                                                                            return _(null, __3);
                                                                        }, true), jsPath);
                                                                    }, true), path);
                                                                })(__cb(_, __frame, -391, 6, function ___(__0, __5) {
                                                                        return (function __$_compile(__then) {
                                                                            if (__5) {
                                                                                return fs.readFile(path, "utf8", __cb(_, __frame, 15, 19, function ___(__0, __6) {
                                                                                    source = __6;
                                                                                    coffee = require("../util/require")("coffee-script");
                                                                                    ...
                                                                                    if (matches) {
                                                                                        if (options.verbose) {
                                                                                            console.log(((("streamline: transforming: " + path) + " to ") + jsPath));
                                                                                        }
                                                                                        ;
                                                                                        ...
                                                                                        if (options.verbose) {
                                                                                            console.log(((("streamline: coffee compiling: " + path) + " to ") + jsPath));
                                                                                        }
                                                                                        ;
                                                                                    }
                                                                                    ;

                                                                                    return fs.writeFile(jsPath, compiled, "utf8", __cb(_, __frame, 28, 6, __then, true));
                                                                                }, true));
                                                                            } else {
                                                                                __then();
                                                                            }
                                                                ...
                                                                return exports.loadFile(__cb(_, __frame, 31, 5, __then, true), path, options);
                                                            }
                                                            ;
                                                        })(__then);
                                                    }
    ...
    var __frame = { name: "exports_compile__3", line: 391 };
    return __func(_, this, arguments, exports_compile__3, 0, __frame, function __$exports_compile__3() {
        ...
        return paths.forEach_(__cb(_, __frame, 48, 1, function __$exports_compile__3() {
            ...
            ;
            _();
        }, true), function __1(_, path) {
            var __frame = { name: "__1", line: 439 };
            return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
                return _compile(__cb(_, __frame, 1, 2, _, true), fspath.resolve(cwd, path), options);
            });
        });
    });
};