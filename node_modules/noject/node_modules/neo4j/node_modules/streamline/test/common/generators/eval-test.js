/*** Generated by streamline 0.4.11 (generators) - DO NOT EDIT ***/var fstreamline__ = require("streamline/lib/generators/runtime");
(fstreamline__.create(function * (_)
{
    var delay_ = fstreamline__.create(delay, 0), delayFail_ = fstreamline__.create(delayFail, 0);
...
,
    ...
    asyncTest("switch with default", 1, fstreamline__.create(function * (_)
    {
        evalTest(fstreamline__.create(function * f(_)
        {
            var g_ = fstreamline__.create(g, 0);
...
,
    ...
    asyncTest("this", 5, fstreamline__.create(function * (_)
    {
        evalTest(fstreamline__.create(function * f(_)
        {
            var delay2_ = fstreamline__.create(delay2, 1);
...
,
    ...
    asyncTest("scoping", 1, fstreamline__.create(function * (_)
    {
        evalTest(fstreamline__.create(function * f(_)
        {
            var test_ = fstreamline__.create(test, 0);
...
,
    ...
    asyncTest("async constructor", 1, fstreamline__.create(function * (_)
    {
        evalTest(fstreamline__.create(function * f(_)
        {
            var Foo_ = fstreamline__.create(Foo, 1);
...
,
    ...
    asyncTest("fibo false async", 1, fstreamline__.create(function * (_)
    {
        evalTest(fstreamline__.create(function * f(_)
        {
            var fibo_ = fstreamline__.create(fibo, 0);
