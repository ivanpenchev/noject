...
;
asyncTest("contexts", 3, fstreamline__.create(function * (_)
{
    var testContext_ = fstreamline__.create(testContext, 0);
...
asyncTest("futures multiplex", 3, fstreamline__.create(function * (_)
{
    var doIt_ = fstreamline__.create(doIt, 1);
    var result1 = 0;
    var result2 = 0;
    var result3 = 0;
